...
class App
{
    ...
    public function __call($method, $args)
    {
        ...
        throw new \BadMethodCallException("O método $method não é um método válido!");
    }
    ...
    protected function finalize(ResponseInterface $response)
    {
        ...
        if (isset($this->container->get('settings')['addContentLengthHeader']) &&
            ...
            if (ob_get_length() > 0) {
                throw new \RuntimeException("Dados inesperados no buffer de saída. ".
                "Talvez você tenha declarações antes de uma tag <?php ou ".
                "observe se a codificação do seu arquivo está com Boom.");
            }
